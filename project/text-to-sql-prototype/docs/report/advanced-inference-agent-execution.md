...
**文档版本**: v1.0
**原始位置**: `feat/advanced-inference/AGENT-TEAM-EXECUTION-SUMMARY.md`
...
| check_correct | Check-Correct  | Greedy Search   | 复杂查询需修正   |
...
| 产品需求            | `../../feat/advanced-inference/PRD.md`                   |
| 技术设计            | `../../feat/advanced-inference/Technical-Design.md`      |
