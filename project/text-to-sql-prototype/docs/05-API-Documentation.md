...
| ADV_001 | InvalidReasoningMode | 推理模式不合法 |
| ADV_002 | InvalidKValue | K值超出范围 |
| ADV_003 | InvalidMaxIterations | 迭代次数超出范围 |
| ADV_004 | AllCandidatesFailed | 全部候选失败 |
| ADV_005 | MaxIterationsReached | 达到最大迭代仍未正确 |
| ADV_006 | CorrectionFailed | 修正过程失败 |
| ADV_007 | InvalidCorrectionStrategy | 修正策略不合法 |
| ADV_008 | InvalidEvalMode | 评估模式不合法 |
| ADV_009 | RateLimitExceeded | 请求频率超限 |
| ADV_010 | InferenceTimeout | 推理超时 |
